...
async function preloadSounds(){
  try{
    ...
    for(const [kind,url] of Object.entries({play:"./assets/domino-place-real.wav?v=7.1.2",double:"./assets/domino-double-real.wav?v=7.1.2",draw:"./assets/domino-draw-real.wav?v=7.1.2",win:"./assets/domino-win.wav?v=7.1.2"})){
...
(async function boot(){
  ...
  if("serviceWorker" in navigator)navigator.serviceWorker.register("./service-worker.js?v=7.1.2").catch(console.warn);
