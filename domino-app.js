...
async function preloadSounds(){
  try{
    ...
    for(const [kind,url] of Object.entries({play:"./assets/domino-place-real.wav?v=8.0.0",double:"./assets/domino-double-real.wav?v=8.0.0",draw:"./assets/domino-draw-real.wav?v=8.0.0",win:"./assets/domino-win.wav?v=8.0.0"})){
